    ...
    return (
     ...
     <div className="container">
        <div className="row p-5 mt-5 mb-5">
         ...
         <div className="col-4 p-5 mt-2 mb-2">
                  <h4 className=" ">
                 <i class="fa-solid fa-user"></i> Zerodha Account
                  </h4>
         ...
         <div className="col-4 p-5 mt-2 mb-2">
                  <h4 className=" ">
                 <i class="fa-solid fa-person"></i> Your Zerodha Account 
                  </h4>
           
            <a href="" style={{textDecoration:"none", lineHeight: "2.5"}} >MarginAverage, Product and Order types</a>
             <br/>
             ...
             <br/>
             <a href="" style={{textDecoration:"none", lineHeight: "2.5"}} >Corporate Acitons</a>
             <br/>
             <a href="" style={{textDecoration:"none", lineHeight: "2.5"}} >Sentinet</a>
             <br/>
             ...
             <br/>
             <a href="" style={{textDecoration:"none", lineHeight: "2.5"}} >GIT</a>
              </div>


               <div className="col-4 p-5 mt-2 mb-2">
                  <h4 className=" ">
                 <i class="fas fa-plus-circle"></i> Funds
                  </h4>
           
            <a href="" style={{textDecoration:"none", lineHeight: "2.5"}} >Adding Funds</a>
             <br/>
             <a href="" style={{textDecoration:"none", lineHeight: "2.5"}} >Fund Withdrawl</a>
             <br/>
            ...
            <a href="" style={{textDecoration:"none", lineHeight: "2.5"}} >Reports</a>
             ...
             <br/>
             <a href="" style={{textDecoration:"none", lineHeight: "2.5"}} >Go Day Challenge</a>
             <br/>
            ...
            <a href="" style={{textDecoration:"none", lineHeight: "2.5"}} >Unerstand Mutual Funds</a>
             <br/>
