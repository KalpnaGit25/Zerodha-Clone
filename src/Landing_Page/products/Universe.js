    ...
    return (
     ...
     <div className="container mt-5">
           <div className="row text-center" >
            ...
            <p>Extend your trading and investment experinece even further with our partner platform.</p>
             ...
             <div className="col-4 p-3 mt-5">
                <img src= "media/images/streakLogo.png" style={{ width: "150px", height: "auto" }} />
             ...
             <div className="col-4 p-3 mt-5">
                <img src= "media/images/dittoLogo - Copy.png" style={{ width: "150px", height: "auto" }}/>
